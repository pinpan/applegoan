/**
 * @ngdoc function
 * @name applegoApp.factory:LocaleService
 * @description
 * # LocaleService
...
angular.module('applegoApp')
  .service('LocaleService', function ($translate, LOCALES, $rootScope, tmhDynamicLocale) {
    ...
    var _LOCALES_CODES = [];
    _LOCALES.forEach(function (locale) {
      _LOCALES_CODES.push(locale);
    });

    var currentLocale = $translate.preferredLanguage();// because of async loading
    ...
    return {
      ...
      getLocalesCodes: function () {
        return _LOCALES_CODES;
      },
      getLocales: function() {
        return localesObj;
      }
